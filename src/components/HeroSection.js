    ...
    <motion.section className="relative overflow-hidden" variants={pageFade} initial="hidden" animate="show">
      <div className="relative h-72 md:h-96 flex items-center">
        ...
        <div className="relative z-10 container-wide">
          ...
          >
            <motion.h1 className="text-4xl md:text-6xl font-bold" initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.25, duration: 0.6 }}>HILL TOP ACADEMY</motion.h1>
